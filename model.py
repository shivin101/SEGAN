...
class Self_Attn(nn.Module):
    ...
    def __init__(self,in_dim,activation):
        ...
        self.channel_div = 8
        self.query_conv = nn.Conv1d(in_channels = in_dim , out_channels = in_dim//self.channel_div , kernel_size= 1)
        self.key_conv = nn.Conv1d(in_channels = in_dim , out_channels = in_dim//self.channel_div , kernel_size= 1)
    ...
    def forward(self,x):
        ...
        proj_query  = self.query_conv(x).view(m_batchsize,-1,width) # B X CX(N)
